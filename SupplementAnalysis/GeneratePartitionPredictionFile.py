...
def GenerateWekaFile(course_path, personality_path, survey_path):
    ...
    for week in range(len(time_array)):
        ...
        for personality_dimension in personality_array:
            ...
            writer.writerow(["video_time", "quiz_time", "questions", "new_posts", "reply", "forum", "forum_time", "forum_login", "forum_friends", "time_on_site", "skip_videos", "speed_up_videos", "max_session_time", "avg_session_time", "std_session_time", "avg_quiz_time", "std_quiz_time", personality_dimension])
